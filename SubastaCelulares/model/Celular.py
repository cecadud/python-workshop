...
class Celular:
    ...
    def registrar_oferta_minima(self):
        ...
        """
        self.__valor_total_ofertas += 50000
        self.__numero_ofertas += 1  # Incrementa en 1 el número de ofertas
    ...
    def registrar_oferta_moderada(self):
        ...
        """
        self.__valor_total_ofertas += 100000
        self.__numero_ofertas += 1
    ...
    def registrar_oferta_abierta(self, monto ):
        ...
        """
        self.__valor_total_ofertas += monto
        self.__numero_ofertas += 1
    ...
    def calcular_incremento_costo_base(self):
        ...
        """
        return (self.__valor_total_ofertas - self.__costo_base)
